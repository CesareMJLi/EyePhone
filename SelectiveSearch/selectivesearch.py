...
def _generate_segments(im_orig, scale, sigma, min_size):
    ...
    """
    # open the Image
    # the image in the numpy array is a matrix of length*width*3-dimension vector in color space
...
def _extract_neighbours(regions):
    ...
    for cur, a in enumerate(R[:-1]):
        # here a are the keys while cur is a index generated by enumerate()
        for b in R[cur + 1:]:
...
def selective_search(
    ...
    S = {}
    # S is also a dictionary and its key are a tuple
